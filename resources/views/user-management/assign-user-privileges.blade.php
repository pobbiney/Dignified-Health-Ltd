@php $pageName = "user_managament"; $subpageName = "assign_privileges"; @endphp
         ...
         <div class="row m-1">
            <div class="col-12 ">
                ...
                <ul class="app-line-breadcrumbs mb-3">
                    ...
                    <li class="active">
                        <a class="f-s-14 f-w-500" href="#">Assign Privileges</a>
                    </li>
                </ul>
            </div>
        </div>
                                    ...
                                    <div class="app-datatable-default overflow-auto">
                                        <form id="formValidationExamples" class="row g-6" action="#" method="POST">
                                                ...
                                                <div align="center">
                                                    ...
                                                    <p align="center" style="display: none; color: limegreen;" id="wait"><img src="{{ asset('assets/images/spinner-grey.gif')}}" > saving privileges. Please wait....</p>
                                                    <p align="center" style="display: none; color: limegreen;" id="wait_fetch"><img src="{{ asset('assets/images/spinner-grey.gif')}}" > Fetching privileges for selected category. Please wait....</p>
                                                </div>
                                                @if ($parents != null)
                                                <div id="listarea">
