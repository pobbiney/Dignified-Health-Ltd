         ...
         <div class="row m-1">
            <div class="col-12 ">
                ...
                <ul class="app-line-breadcrumbs mb-3">
                    ...
                    <li class="active">
                        <a class="f-s-14 f-w-500" href="#">Update Links</a>
                    </li>
                </ul>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="app-form">
                            <div class="row">
                                    ...
                                    <div class="col-6">
                                        <form enctype="multipart/form-data" method="post" action="{{ route('edit-links-process',$id) }}">
                                            @csrf
                                            <div class="row">
                                                    <div class="mb-3">
                                                        <label for="userName" class="form-label">Link Name</label>
                                                        <input type="text" name="name" class="form-control" placeholder="Enter Link Name" value="{{ $data->name }}"/>
                                                        @error('name') <small style="color:red"> {{ $message}}</small> @enderror
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="userName" class="form-label">Link Address</label>
                                                        <input type="text" class="form-control"   name="link" placeholder="Enter Link Address   Here" value="{{ $data->link }}">
