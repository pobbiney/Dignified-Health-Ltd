         ...
         <div class="row m-1">
            <div class="col-12 ">
                ...
                <ul class="app-line-breadcrumbs mb-3">
                    ...
                    <li class="active">
                        <a class="f-s-14 f-w-500" href="#">Add Material</a>
                    </li>
                </ul>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="app-form">
                            <div class="row">
                                    ...
                                    <div class="col-6">
                                        <form enctype="multipart/form-data" method="post" action="{{ route('add-resource-process') }}">
                                            @csrf
                                            <div class="row">
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        @error('document') <small style="color:red"> {{ $message}}</small> @enderror
                                                    </div>
                                                    <div class="mb-3">
