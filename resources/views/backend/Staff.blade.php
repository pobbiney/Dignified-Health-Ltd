         ...
         <div class="row m-1">
            <div class="col-12 ">
                ...
                <ul class="app-line-breadcrumbs mb-3">
                    ...
                    <li class="active">
                        <a class="f-s-14 f-w-500" href="#">Add Staff</a>
                    </li>
                </ul>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="app-form">
                            <div class="row">
                                ...
                                <form class="app-form" enctype="multipart/form-data" method="post" action="{{ route('add-staff-process') }}">
                                    @csrf
                                    <div class="row">
                                        <div class="col-12">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="othername" class="form-control" placeholder="Enter Name"
                                                    >
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-xl-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" rows="5" name="profile"
                                                        placeholder="Enter Your Personal Profile"></textarea>
