...
<link rel="icon" href="{{ asset('assets/images/logo/DIGNIFIED HEALTH LTD OFFICIAL LOGO.png')}}" type="image/x-icon">
<link rel="shortcut icon" href="{{ asset('assets/images/logo/DIGNIFIED HEALTH LTD OFFICIAL LOGO.png')}}" type="image/x-icon">
                ...
                <div class="row">
                    ...
                    <div class="col-12 p-0">
                        <div class="login-form-container">
                            <div class="mb-4">
                                <a class="logo1" >
                                    <img alt="#" src="../assets/images/logo/DIGNIFIED HEALTH LTD OFFICIAL LOGO.png" width="150" class="">
                                </a>
                            </div>
                            <div class="form_container">
                                ...
                                <form class="app-form" action="{{ route('authentication-process') }}" method="POST">
                                    ...
                                    <div class="mb-3 text-center">
                                        ...
                                        <p class="f-s-12 text-secondary">Get started with our app, just login with your  
